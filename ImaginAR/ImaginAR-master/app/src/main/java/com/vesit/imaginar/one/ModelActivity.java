        ...
        PixelCopy.request(view, bitmap, (copyResult) -> {
            if (copyResult == PixelCopy.SUCCESS) {
                try {
                    ...
                    Toast toast = Toast.makeText(ModelActivity.this, e.toString(),
                            Toast.LENGTH_LONG);
                    toast.show();
                    return;
                }
                ...
                snackbar.setAction("Open in Photos", v -> {
                    ...
                    Uri photoURI = FileProvider.getUriForFile(ModelActivity.this,
                            ModelActivity.this.getPackageName() + ".ar.codelab.name.provider",
                            photoFile);
                ...
                Toast toast = Toast.makeText(ModelActivity.this,
